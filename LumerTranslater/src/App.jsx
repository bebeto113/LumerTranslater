  ...
  return (
    <div className="min-h-screen bg-gray-300 flex flex-col">
      ...
      <main className="flex-grow flex items-start justify-center px-4 py-8">
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-ms overflow-hidden">

          <div className=" flex items-center justify-between p-4 border-b border-gray-200"> {/* Parte dos idiomas */}
            <select
              value={sourceLang}
            ...
            >
              {languages.map((lang) => (
                <option
                  key={lang.code}
                  value={lang.code}
                  className="text-sm text-white bg-gray-500 border-none focus:outline-none cursor-pointer"
                >
                  {lang.name}
                </option>
              ))}
            ...
            <button onClick={swipeTranslate} className="p-2 rounded-full hover:bg-gray-100 focus:outline-none">
              <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-2"> {/* Parte dos textos */}
            <div className="p-4"> {/* input Digite */}
              <textarea
                value={sourceText}
            ...
            <div className="p-4 relative bg-gray-200 border-l border-gray-100"> {/* Input traducao */}
      ...
      <footer className="bg-white border-t border-gray-200 mt-auto ">
        <div className="max-w-5xl mx-auto px-4 py-3 text-sm text-headerColor">
          &copy; {new Date().getFullYear()} LumerTranslater
        </div>
      </footer>
    </div>
  );
